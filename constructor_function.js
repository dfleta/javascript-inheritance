...
console.log("Range es el constructor de r: ", r instanceof Range);

// Pero Range no es el prototipo de r
console.log("Range no es el prototipo de r: " + Range.isPrototypeOf(r));

// la propiedad constructor es un objeto, no un string
console.log("Propiedad constructor de Range: " + Range.constructor.toString());
 ...
 * there is no way to specify the class attribute for
 * your own classes of objects.
 */
console.log("Propiedad class del objeto: " + Object.prototype.toString.call(r).slice(8, -1));